function fig_hdl = Datos_imagenes_granuladovoxel_english_build
% DATOS_IMAGENES_BUILD
%-------------------------------------------------------------------------------
% File name   : Datos_imagenes_granuladovoxel_english_build.m
%-------------------------------------------------------------------------------
...
% Creation of all uicontrols
		...
		handles.subida_archivo_panel = uipanel( ...
            ...
            'Foregroundcolor', [0.4 0.3 1], ...
            'HighlightColor', [1 0.35 0], ...
			'Title', 'Excel file images upload', ...
            'visible', 'off', ...
            'TitlePosition', 'Centertop');
        ...
        handles.subida_archivo_panel_nuevo = uipanel( ...
			...
			'Units', 'characters', ...
			'Position', [119.8 10 100.2 21], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [0.4 0.3 1], ...
            'HighlightColor', [1 0.35 0], ...
			'Title', 'Without Excel file images upload', ...
            'visible', 'off', ...
            'TitlePosition', 'Centertop');
        ...
        handles.lvox_texto = uicontrol( ...
			'Parent', handles.subida_manual_panel, ...
			'Tag', 'lvox_texto', ...
			'UserData', zeros(1,0), ...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [5.6 4.134615385 32.2 3.30769230769231], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
			'String', {'Voxel';'dimension [nm]'});
        
        handles.lvox_texto2 = uicontrol( ...
			'Parent', handles.subida_manual_panel, ...
			'Tag', 'lvox_texto2', ...
			'UserData', zeros(1,0), ...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [40.8 4.776923077 23.2 1.69230769230769], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
		...
		handles.dpo_mat_texto = uicontrol( ...
			...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [5.6 0.423076923 32.2 3.30769230769231], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
			'String', {'Average particle';'diameter [nm]'});
        ...
        handles.dir_img_texto_nuevo = uicontrol( ...
			...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [2.2 12.438461538462 30.6 2.90769230769231], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
			'String', {'Images','folder'});
        ...
        handles.npix_texto_nuevo = uicontrol( ...
			...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [9.6 9.692307692 25.4 1.30769230769231], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
			'String', 'n. pixels/100nm');
        
        handles.lvox_texto_nuevo = uicontrol( ...
			'Parent', handles.subida_archivo_panel_nuevo, ...
			'Tag', 'lvox_texto_nuevo', ...
			'UserData', zeros(1,0), ...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [5.6 5 32.2 3.30769230769231], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
			'String', {'Voxel';'dimension [nm]'});
        
        handles.lvox_texto_nuevo2 = uicontrol( ...
			'Parent', handles.subida_archivo_panel_nuevo, ...
			'Tag', 'lvox_texto_nuevo2', ...
			'UserData', zeros(1,0), ...
			'Style', 'text', ...
			'Units', 'characters', ...
		...
		handles.guardar_datos_boton = uicontrol( ...
			...
			'Style', 'pushbutton', ...
			'Units', 'characters', ...
			'Position', [69.2 4.7 24.2 2.23076923076923], ...
			'String', 'Save data', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ... 
        ...
        handles.dir_img_boton_nuevo = uicontrol( ...
			...
			'Style', 'pushbutton', ...
			'Units', 'characters', ...
			'Position', [30.8 13.0615384615385 4.4 1.76923076923077], ...
			'String', '...', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
        ...
        handles.instrucciones_boton_nuevo = uicontrol( ...
			...
			'Style', 'pushbutton', ...
			'Units', 'characters', ...
			'Position', [42.2 16.5384615384615 20.2 2.07692307692308], ...
			'String', 'Instructions', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [0.4 0.3 1], ...
        ...
        handles.tomar_datos_boton_nuevo = uicontrol( ...
			...
			'Style', 'pushbutton', ...
			'Units', 'characters', ...
			'Position', [69.2 5.2 24.2 2.23076923076923], ...
			'String', 'Take data', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ... 
...
%--------------------------------------------------..------------------
        ...
        handles.sub_grupo_sin = uicontrol( ...
			...
			'String', 'Upload without Excel file', ...
            'value', 0, ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
		...
		handles.dpomat_entrada = uicontrol( ...
			...
			'Style', 'edit', ...
			'Units', 'characters', ...
			'Position', [40.8 1.346153846 23.2 1.69230769230769], ...
			'BackgroundColor', [1 1 1], ...
			'String', 'dpo', ...
            'FontSize', 12, ...
            'FontName', 'Candara');
        ...
        handles.dir_img_nuevo = uicontrol( ...
			...
			'Style', 'edit', ...
			'Units', 'characters', ...
			'Position', [36.2000000000001 12.7538461538462 60.2 2.23076923076923], ...
			'BackgroundColor', [1 1 1], ...
			'String', {''}, ...
            'enable', 'off');
        ...
        handles.npix_entrada_nuevo = uicontrol( ...
			...
			'Style', 'edit', ...
			'Units', 'characters', ...
			'Position', [40.8 9.5 23.2 1.69230769230769], ...
			'BackgroundColor', [1 1 1], ...
			'String', 'npix', ...
            'FontSize', 12, ...
            'Callback', @edit_npix_nuevo_Callback,...
            'FontName', 'Candara');
...
%--------------------------------------------------
    function edit_npix_Callback(hObject,evendata) %#ok<INUSD>
        lvox=(100/str2double(get(handles.npix_entrada,'string')));
        set(handles.lvox_texto2,'string',lvox);
    end
%--------------------------------------------------
    function edit_npix_nuevo_Callback(hObject,evendata) %#ok<INUSD>
        lvox_nuevo=(100/str2double(get(handles.npix_entrada_nuevo,'string')));
        set(handles.lvox_texto_nuevo2,'string',lvox_nuevo);
    end
%% ---------------------------------------------------------------------------
...
%% ---------------------------------------------------------------------------
    function tomar_datos_boton_Callback(hObject,evendata) %#ok<INUSD>
        ...
        if isequal(handles.txt_datos,0) || isequal(handles.dir_img_grupo,0) 
            ...
            set(handles.tomar_datos_boton,'str','LOADING...','backg',[1 .6 .6]) % Change color of button. 
...
%             handles.dpomat=handles.data(:,3); setappdata(0,'dpomat',handles.dpomat');%CAMBIO
            ...
            set(handles.tomar_datos_boton,'String','READY','backg',[0 .9 0])  % Now reset the button features.
        
            if strcmp(get(handles.tomar_datos_boton,'String'),'READY')==1
...
%% ---------------------------------------------------------------------------
    function tomar_datos_boton_nuevo_Callback(hObject,evendata) %#ok<INUSD>
        ...
        elseif handles.npix_nuevo>0 && handles.dpo_mat_nuevo>0
            set(handles.tomar_datos_boton_nuevo,'str','LOADING...','backg',[1 .6 .6]) % Change color of button. 
          ...
          % Filtro de extension (sólo queremos los archivos cuya extensión coincida con la deseada)
           ...
           setappdata(0,'data',handles.data);
            ...
            if strcmp(get(handles.tomar_datos_boton_nuevo,'String'),'READY')==1
                set (handles.siguiente_boton,'enable','on');
            end
...
%% ---------------------------------------------------------------------------
	function guardar_datos_boton_Callback(hObject,evendata) %#ok<INUSD>
        ...
        elseif handles.npix>0 && handles.dpo_mat>0
            ...
            set(handles.guardar_datos_boton,'String','READY','backg',[0 .9 0])  % Now reset the button features.  
        else 
            error=errordlg('Algún dato introducido no es un número positivo','Error');
        ...
        if strcmp(get(handles.guardar_datos_boton,'String'),'READY')==1
            set (handles.siguiente_boton,'enable','on');
        end
    end
