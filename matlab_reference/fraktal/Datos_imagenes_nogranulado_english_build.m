function fig_hdl = Datos_imagenes_nogranulado_english_build
% DATOS_IMAGENES_NOGRANULADO_BUILD
%-------------------------------------------------------------------------------
% File name   : Datos_imagenes_nogranulado_english_build.m
%-------------------------------------------------------------------------------
...
% Creation of all uicontrols
        ...
        handles.lvox_texto = uicontrol( ...
			...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [40 5 25.4 1.30769230769231], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
        ...
        handles.lvox_texto_nuevo = uicontrol( ...
			...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [40 2.3 25.4 1.30769230769231], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [0 0 0],...
			'String', 'lvox');
...
%--------------------------------------------------..------------------
		...
		handles.dpomat_entrada = uicontrol( ...
			...
			'Units', 'characters', ...
            'visible', 'off', ...
			'Position', [40.8 0 23.2 1.69230769230769], ...
			'BackgroundColor', [1 1 1], ...
			'String', '1', ...
            'FontSize', 12, ...
            'FontName', 'Candara');
		...
		handles.dpomat_entrada_nuevo = uicontrol( ...
			...
			'Units', 'characters', ...
            'visible', 'off', ...
			'Position', [70 0 23.2 1.69230769230769], ...
			'BackgroundColor', [1 1 1], ...
			'String', '1', ...
            'FontSize', 12, ...
            'FontName', 'Candara');
...
%% ---------------------------------------------------------------------------
	function edit_npix_Callback(hObject,evendata) %#ok<INUSD>
        ...
        set(handles.lvox_texto,'string',lvox);
    end
%% ---------------------------------------------------------------------------
	function edit_npix_nuevo_Callback(hObject,evendata) %#ok<INUSD>
        ...
        set(handles.lvox_texto_nuevo,'string',lvox_nuevo);
    end
%% ---------------------------------------------------------------------------
