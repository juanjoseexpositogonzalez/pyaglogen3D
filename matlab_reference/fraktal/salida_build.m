function fig_hdl = salida_build
% SALIDA_BUILD
%-------------------------------------------------------------------------------
% File name   : salida_build.m
%-------------------------------------------------------------------------------
...
if size(handles.dfmat{1},1)>=2 || handles.estudio==1
    ...
    set(handles.ver_tabla_boton,'visible','on');
else
...
if size(handles.version,1)>1 && size(handles.dfmat{1},1)>=2
    set(handles.seleccion_versiones_panel,'visible','on');
    set(handles.v_1_check,'value',1);
    set(handles.v_2_check,'value',1);
    set(handles.comp_versiones_panel,'visible','on');
end
...
% Creation of all uicontrols
        ...
        handles.eje_y_panel = uibuttongroup( ...
            ...
            'Tag', 'eje_y_panel', ...
            'Units', 'characters', ...
            'Position', [9.8 41.5 70 10.6153846153846], ...
            'Title', 'Eje y', ...
            ...
            'TitlePosition', 'Centertop', ...
            'SelectionChangeFcn', @clic_boton_Callback);
 
        handles.eje_x_panel = uibuttongroup( ...
            'Parent', handles.figura_salida, ...
            'Tag', 'eje_x_panel', ...
            'Units', 'characters', ...
            'Position', [93.5 41.5 70 10.6153846153846], ...
            'Title', 'Eje x', ...
            'TitlePosition', 'centertop', ...
            'visible', 'off', ...
            'FontSize', 12, ...
        ...
        handles.seleccion_versiones_panel = uibuttongroup( ...
            'Parent', handles.figura_salida, ...
            'Tag', 'seleccion_versiones_panel', ...
            'Units', 'characters', ...
            'Position', [9.8 38.8 40 2.5], ...
            'TitlePosition', 'centertop', ...
            'visible', 'off', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
        ...
        handles.comp_versiones_panel = uipanel( ...
            'Parent', handles.figura_salida, ...
            'Tag', 'ambas_versiones_panel', ...
            'Units', 'characters', ...
            'Position', [177 41.5 40 10.6153846153846], ...
            'Title', 'Comp. versiones', ...
            'visible', 'off', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [0.4 0.3 1], ...
        ...
        handles.npo_x_check = uicontrol( ...
            ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
            'String', 'nº partículas primarias');
        ...
        handles.aplast_x_texto = uicontrol( ...
            ...
            'Style', 'radiobutton', ...
            'Units', 'characters', ...
            'Position', [21 3.5 40 3.5], ...
            'visible', 'off', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
            'String', '<html>Coeficiente de aplastamiento &#948;</html>');
        ...
        handles.npo_comp_check = uicontrol( ...
            'Parent', handles.comp_versiones_panel, ...
            'Tag', 'npo_comp_check', ...
            'Style', 'radiobutton', ...
            'Units', 'characters', ...
            'Position', [2.4 6.69230769230771 35 1.76923076923077], ...
            'String', 'nº partículas primarias', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
            'Callback', @npo_comp_check_Callback);
 
        handles.Df_comp_check = uicontrol( ...
            'Parent', handles.comp_versiones_panel, ...
            'Tag', 'Df_comp_check', ...
            'Style', 'radiobutton', ...
            'Units', 'characters', ...
            'Position', [2.4 1.30769230769232 35 1.76923076923077], ...
            'String', 'Dimensión fractal', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
            'Callback', @Df_comp_check_Callback);
 
        handles.k_comp_check = uicontrol( ...
            'Parent', handles.comp_versiones_panel, ...
            'Tag', 'k_comp_check', ...
            'Style', 'radiobutton', ...
            'Units', 'characters', ...
            'Position', [2.4 4.00000000000001 35 1.76923076923077], ...
            'String', 'Prefactor', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
            'Callback', @k_comp_check_Callback);
 
        % --- CHECKBOXES -------------------------------------
        
        handles.v_1_check = uicontrol( ...
            'Parent', handles.seleccion_versiones_panel, ...
            'Tag', 'v_1_check', ...
            'Style', 'checkbox', ...
            'Units', 'characters', ...
            'Position', [3 0.2 17 1.76923076923077], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
            'String', 'versión 1');
        
        handles.v_2_check = uicontrol( ...
            'Parent', handles.seleccion_versiones_panel, ...
            'Tag', 'v_2_check', ...
            'Style', 'checkbox', ...
            'Units', 'characters', ...
            'Position', [21 0.2 17 1.76923076923077], ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
            'String', 'versión 2');
        ...
        handles.desv_tip_imprimir_check = uicontrol( ...
            ...
            'String', 'Desviación típica datos', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0]);
...
%% ---------------------------------------------------------------------------
    function clic_boton_Callback(hObject,evendata) %#ok<INUSD>
        if get(handles.npo_x_check,'value')==1 && get(handles.npo_y_check,'value')==1
            set(handles.npo_comp_check,'value',1);
        elseif get(handles.Df_x_check,'value')==1 && get(handles.Df_y_check,'value')==1
            set(handles.Df_comp_check,'value',1);
        elseif get(handles.k_x_check,'value')==1 && get(handles.k_y_check,'value')==1
            set(handles.k_comp_check,'value',1);
        else
            set(handles.npo_comp_check,'value',0);
            set(handles.Df_comp_check,'value',0);
            set(handles.k_comp_check,'value',0);
        end
    end
 
%% ---------------------------------------------------------------------------
    function npo_comp_check_Callback(hObject,evendata) %#ok<INUSD>
        if get(handles.Df_comp_check,'value')==1
            set(handles.Df_comp_check,'value',0);
        elseif get(handles.k_comp_check,'value')==1
            set(handles.k_comp_check,'value',0);
        end
        set(handles.npo_x_check,'value',1);
        set(handles.npo_y_check,'value',1);
    end
 
%% ---------------------------------------------------------------------------
    function Df_comp_check_Callback(hObject,evendata) %#ok<INUSD>
        if get(handles.npo_comp_check,'value')==1
            set(handles.npo_comp_check,'value',0);
        elseif get(handles.k_comp_check,'value')==1
            set(handles.k_comp_check,'value',0);
        end
        set(handles.Df_x_check,'value',1);            
        set(handles.Df_y_check,'value',1);
    end
 
%% ---------------------------------------------------------------------------
    function k_comp_check_Callback(hObject,evendata) %#ok<INUSD>
        if get(handles.npo_comp_check,'value')==1
            set(handles.npo_comp_check,'value',0);
        elseif get(handles.Df_comp_check,'value')==1
            set(handles.Df_comp_check,'value',0);
        end        
        set(handles.k_x_check,'value',1);            
        set(handles.k_y_check,'value',1);
    end
...
%% ---------------------------------------------------------------------------
    function exportar_tabla_boton_Callback(hObject,evendata) %#ok<INUSD>
        ...
        if exist(archivo_nuevo, 'file')
            msgbox(strcat('La tabla ha sido guardada correctamente en: ' ,archivo_nuevo),'Información');
        else
            msgbox(strcat('Ha ocurrido un error al guardar el archivo: ' ,archivo_nuevo),'Error');
        end
...
%% ---------------------------------------------------------------------------
    function exportar_graf_boton_Callback(hObject,evendata) %#ok<INUSD>
        ...
        if isempty(handles.nombre_archivo)==1
            ...
            mensaje=msgbox(strcat('El gráfico ha sido guardado correctamente en: ' ,handles.nombre_archivo),'Información');
                    kids0=findobj(mensaje,'Type','UIControl');
                    kids1=findobj(mensaje,'Type','Text');
        ...
        if handles.estudio==1
            ...
            while i<=size(handles.dfmat,1)
                ...
                switch get(get(handles.eje_y_panel,'SelectedObject'),'Tag')
                    case 'Rg_y_check', p=plot (cell2mat(handles.dfmat{i}(:,13)),cell2mat(handles.dfmat{i}(:,3)),'-k'); xlabel('\delta'); ylabel('r_g'); 
                    case 'Ap_y_check', p=plot (cell2mat(handles.dfmat{i}(:,13)),cell2mat(handles.dfmat{i}(:,4)),'-k'); xlabel('\delta'); ylabel('A_p'); 
                    case 'npo_y_check'
...
function [salida,matriz]= fnc_salida(dfmat,Rg,Ap,npo,Df,k,z,J,vol,masa,Asup,media_check,desv_tip_check,version,grupo,estudio)
    ...
    if  strcmp(version,'2') && estudio==0
        salida{1,1}=strcat(['Coef. aplastamiento= ',num2str(dfmat{1,13})]);%!!
    elseif estudio==1                                           %!!%!!%!!%!!%!!%!!               
        salida{1,1}=strcat('');
    end
    ...
    if Rg==1
        fallo=0;
        salida{3,columna}='Radio de giro';
        salida{4,columna}='nm';
        for j=4:size(dfmat,1)+3
    ...
    if Ap==1
        fallo=0;
        salida{3,columna}='Área proyectada';
    ...
    if npo==1
        fallo=0;
        salida{3,columna}='nº partículas primarias';
        salida{4,columna}='-';
        for j=4:size(dfmat,1)+3
    ...
    if Df==1
        fallo=0;
        salida{3,columna}='Dimensión fractal';
        salida{4,columna}='-';
        for j=4:size(dfmat,1)+3
    ...
    if z==1
        fallo=0;
        salida{3,columna}='Exponente de solape';
        salida{4,columna}='-';
        for j=4:size(dfmat,1)+3
    ...
    if J==1
        fallo=0;
        salida{3,columna}='Índice de coordinación';
        salida{4,columna}='-';
        for j=4:size(dfmat,1)+3
    ...
    if vol==1
        fallo=0;
        salida{3,columna}='Volumen del aglomerado';
    ...
    if masa==1
        fallo=0;
        salida{3,columna}='Masa del aglomerado';
        salida{4,columna}='pg';
        for j=4:size(dfmat,1)+3
    ...
    if Asup==1
        fallo=0;
        salida{3,columna}='Área superficial del aglomerado';
        salida{4,columna}='nm^2';
        for j=4:size(dfmat,1)+3
    ...
    if estudio==1
        salida{3,columna}='Coef. Aplastamiento';
        salida{4,columna}='-';
        for j=4:size(dfmat,1)+3
    ...
    if media_check==1
        salida{size(salida,1)+2,1}='Media';
    ...
    if desv_tip_check==1
        if media_check==1
            salida(size(salida,1)+1,1)={'Desviación típica'};
        else
            salida(size(salida,1)+2,1)={'Desviación típica'};
        end
    ...
    salida{size(salida,1)+2,1}='nº ejecuciones exitosas';
    salida{size(salida,1),2}=exito;
    salida{size(salida,1)+1,1}='nº ejecuciones fallidas';
...
function [p,igual,x,y]=fnc_plot(panelx,panely,dfmat)
    igual=0; x=0; y=0;
        switch panelx
            case 'Rg_x_check'
                switch panely
                    case 'Rg_y_check', p=plot (cell2mat(dfmat(:,3)),cell2mat(dfmat(:,3)),'k.'); xlabel('r_g'); ylabel('r_g'); igual=1; 
                    case 'Ap_y_check', p=plot (cell2mat(dfmat(:,3)),cell2mat(dfmat(:,4)),'k.'); xlabel('r_g'); ylabel('A_p'); igual=1;
                    case 'npo_y_check'
                        fila=1;i=1;
                        ...
                        p=plot (mat3(:),mat5(:),'k.'); xlabel('r_g'); ylabel('n_p_o');
                    case 'Df_y_check', p=plot (cell2mat(dfmat(:,3)),cell2mat(dfmat(:,6)),'k.'); xlabel('r_g'); ylabel('D_f'); y=1;
                    case 'k_y_check', p=plot (cell2mat(dfmat(:,3)),cell2mat(dfmat(:,7)),'k.'); xlabel('r_g'); ylabel('k'); y=2;
                end
            case 'Ap_x_check'
                switch panely
                    case 'Rg_y_check', p=plot (cell2mat(dfmat(:,4)),cell2mat(dfmat(:,3)),'k.'); xlabel('A_p'); ylabel('r_g'); igual=1;
                    case 'Ap_y_check', p=plot (cell2mat(dfmat(:,4)),cell2mat(dfmat(:,4)),'k.'); xlabel('A_p'); ylabel('A_p'); igual=1;
                    case 'npo_y_check'
                        fila=1;i=1;
                        while i<=size(dfmat,1)
                            if cell2mat(dfmat(i,5))~=0
                        ...
                        p=plot (mat4(:),mat5(:),'k.'); xlabel('A_p'); ylabel('n_p_o');
                    case 'Df_y_check', p=plot (cell2mat(dfmat(:,4)),cell2mat(dfmat(:,6)),'k.'); xlabel('A_p'); ylabel('D_f'); y=1;
                    case 'k_y_check', p=plot (cell2mat(dfmat(:,4)),cell2mat(dfmat(:,7)),'k.'); xlabel('A_p'); ylabel('k'); y=2;
                end
            case 'npo_x_check'
                switch panely
                    case 'Rg_y_check'
                        ...
                        p=plot (mat5(:),mat3(:),'k.'); xlabel('n_p_o'); ylabel('r_g');
                    case 'Ap_y_check'
                        fila=1;i=1;
                        while i<=size(dfmat,1)
                            if cell2mat(dfmat(i,5))~=0
                        ...
                        p=plot (mat5(:),mat4(:),'k.'); xlabel('n_p_o'); ylabel('A_p');
                    case 'npo_y_check'
                        fila=1;i=1;
                        while i<=size(dfmat,1)
                            if cell2mat(dfmat(i,5))~=0
            ...
            case 'Df_x_check'
                switch panely
                    case 'Rg_y_check', p=plot (cell2mat(dfmat(:,6)),cell2mat(dfmat(:,3)),'k.'); xlabel('D_f'); ylabel('r_g'); x=1;
                    case 'Ap_y_check', p=plot (cell2mat(dfmat(:,6)),cell2mat(dfmat(:,4)),'k.'); xlabel('D_f'); ylabel('A_p'); x=1;
                    case 'npo_y_check'
                        fila=1;i=1;
                        while i<=size(dfmat,1)
                            if cell2mat(dfmat(i,5))~=0
                        ...
                        p=plot (mat6(:),mat5(:),'k.'); xlabel('r_g'); ylabel('n_p_o'); x=1;
            ...
            case 'k_x_check'
                switch panely
                    case 'Rg_y_check', p=plot (cell2mat(dfmat(:,7)),cell2mat(dfmat(:,3)),'k.'); xlabel('k'); ylabel('r_g'); x=2;
                    case 'Ap_y_check', p=plot (cell2mat(dfmat(:,7)),cell2mat(dfmat(:,4)),'k.'); xlabel('k'); ylabel('A_p'); x=2;
                    case 'npo_y_check'
                        fila=1;i=1;
                        while i<=size(dfmat,1)
                            if cell2mat(dfmat(i,5))~=0
