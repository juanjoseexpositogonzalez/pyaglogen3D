function fig_hdl = Tipo_fractal_english_build
% TIPO_FRACTAL_BUILD
%-------------------------------------------------------------------------------
% File name   : Tipo_fractal_english_build.m
%-------------------------------------------------------------------------------
...
% Creation of all uicontrols
		...
		handles.npix_texto = uicontrol( ...
            ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
			'String', {'This option is only valid for branched-fractal structures formed by spherical particles.'}, ...
        ...
        handles.granulado_voxel_texto = uicontrol( ...
            ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
			'String', {'This option allows the study, using voxels as basic elements, of branched-fractal structures formed by spherical particles.'}, ...
			'HorizontalAlignment', 'left');
		...
		handles.dir_img_texto = uicontrol( ...
            ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
			'String', {'The voxel method allows the study of any type of object with branched-fractal geometry.'}, ...
			'HorizontalAlignment', 'left');
         ...
         handles.calculo_fractal_esfera_texto = uicontrol( ...
            ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
			'String', {'Select this option if you wish to do a fractal analysis of the images using spherical primary particles as basic elements.'}, ...
			'HorizontalAlignment', 'left');
        ...
        handles.calculo_fractal_voxel_texto = uicontrol( ...
            ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
			'String', {'Select this option if, despite studying fractals formed by spherical particles, you wish to do a fractal analysis of the images using voxels as basic elements.'}, ...
			'HorizontalAlignment', 'left');
        ...
        handles.calculo_voxel_texto = uicontrol( ...
            ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
			'String', {'Select this option if you wish to do fractal analysis of any object using voxels as basic elements.'}, ...
			'HorizontalAlignment', 'left');
        ...
        handles.calculo_voxel = uicontrol( ...
			...
			'String', {'VOXEL-BASED CALCULATION'}, ...
			'HorizontalAlignment', 'left');
		...
		handles.frac_no_granulado = uicontrol( ...
			...
			'String', 'BRANCHED GRANULATED FRACTAL', ...
            'value', 0, ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...            
            'Foregroundcolor', [1 0.35 0],...
        ...
        handles.frac_no_granulado_esfera = uicontrol( ...
			...
			'String', 'PRIMARY SPHERICAL-BASED CALCULATION', ...
            'value', 0, ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...            
            'Foregroundcolor', [1 0.35 0],...
		...
		handles.frac_granulado = uicontrol( ...
			...
			'String', 'BRANCHED NON-GRANULATED FRACTAL', ...
            'value', 0, ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
