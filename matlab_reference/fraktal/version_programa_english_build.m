function fig_hdl = version_programa_english_build
% VERSION_PROGRAMA_BUILD
%-------------------------------------------------------------------------------
% File name   : version_programa_english_build.m
%-------------------------------------------------------------------------------
...
% Creation of all uicontrols
        ...
        handles.correcciones_panel = uipanel( ...
            ...
            'visible', 'on', ...
            'Title', 'Correction of the gyration radius', ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [0.4 0.3 1], ...
            'HighlightColor', [1 0.35 0], ...
        ...
        handles.correccion_voxel_texto = uicontrol( ...
            ...
            'String', 'This option is not implemented for voxels, since some research about the correction of gyration radius is needed.');
        ...
        handles.estudio_boton = uicontrol( ...
            ...
            'String', {'<html>Parametric study &#948;</html>'}, ...
            'FontSize', 12, ...
            'FontName', 'Candara', ...
            'Foregroundcolor', [1 0.35 0],...
...
%% ---------------------------------------------------------------------------
    function siguiente_boton_Callback(hObject,evendata) %#ok<INUSD>
        ...
        if error==0
            ...
            set(handles.siguiente_boton,'str','LOADING...','backg',[1 .6 .6]) % Change color of button. 
            ...
            set(handles.siguiente_boton,'String','Take data','backg',col)  % Now reset the button features.
            
%             figure; A=cell2mat(handles.dfmat{1}(:,8)); B=cell2mat(handles.dfmat{1}(:,10)); 
%             plot(A,B,'-')
            close;
            salida_english_build;
