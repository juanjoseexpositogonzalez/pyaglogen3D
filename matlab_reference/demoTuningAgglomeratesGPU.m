...
formatSpec = '%03.0f';
formatSpec2 = '%02.0f';
NofPart     = zeros( numSim, maxAgglom, 'gpuArray' );
RadiusOfGir = zeros( numSim, maxAgglom, 'gpuArray' );
maxJ        = zeros( numSim, maxAgglom, 'gpuArray' );
tAgglo      = zeros( numSim, maxAgglom, 'gpuArray' );
tImage      = zeros( numSim, maxAgglom, 'gpuArray' );
intentos    = zeros( numSim, maxAgglom, 'gpuArray' );
part        = [];
vec         = {};
escala      = {};
