...
pub fn run_ballistic_internal(params: BallisticParams, seed: u64) -> SimulationResult {
    ...
    while particles.len() < params.n_particles {
        ...
        for _ in 0..params.max_ray_steps {
            ...
            for &idx in &candidates {
                ...
                let contact_dist =
                    sintered_contact_distance(new_radius, other.radius, sintering_coeff);
    ...
    let coord_mean =
        coordination.iter().map(|&c| c as f64).sum::<f64>() / coordination.len() as f64;
