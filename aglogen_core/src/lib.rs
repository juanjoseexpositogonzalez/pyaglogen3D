...
#[pyfunction]
#[pyo3(signature = (image, npix, dpo, delta=1.1, correction_3d=false, pixel_min=10, pixel_max=240, npo_limit=5, escala=100.0))]
fn fraktal_granulated_2012(
    ...
    let params = Granulated2012Params::new(
        npix, dpo, delta, correction_3d, pixel_min, pixel_max, npo_limit, escala
    );
...
#[pyfunction]
#[pyo3(signature = (image, npix, escala=100.0, correction_3d=false, pixel_min=10, pixel_max=240, m_exponent=1.0))]
fn fraktal_voxel_2018(
    ...
    let params = Voxel2018Params::new(
        npix, escala, correction_3d, pixel_min, pixel_max, m_exponent
    );
