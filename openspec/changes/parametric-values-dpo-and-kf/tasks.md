...
- [x] P2.5 — Write cargo regression tests: default (Fixed) produces bitwise identical results to baseline; Normal mode -> result.dpo_used within [μ-3σ, μ+3σ]; reproducibility with seed verified (file: `aglogen_core/engine/src/simulation/tunable_cc.rs`)
